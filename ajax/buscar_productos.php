<?php
	...
	if($action == 'ajax'){
		// escaping, additionally removing everything that could be (html/javascript-) code
		 ...
		 $aColumns = array('codigo_producto', 'nombre_producto','status_stock');//Columnas de busqueda
		 $sTable = "products";
		 $sWhere = "";
		if ( $_GET['q'] != "" )
		{
			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<input type="hidden" value="<?php echo $status_stock;?>" id="stock<?php echo $id_producto;?>">
