    ...
    <div class="container">
		...
		<div class="panel-heading">
		    <div class="btn-group pull-right">
				<button type='button' class="btn btn-primary" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-plus" ></span> Nuevo Registro</button>
			</div>
			<h4><i class='glyphicon glyphicon-search'></i> Buscar Registros</h4>
		</div>			
